...
* Iceberg dest-before — **PARTIAL** on filesystem CoW: missing=0, COUNT=2,
  ...
  filesystem CoW (`D \ S` then existing delete). pyiceberg SqlCatalog
  live scan / leftover not run this host (pyiceberg absent). MoR /
