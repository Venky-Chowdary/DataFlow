...
70 passed in 5.22s
  ...
  Lakehouse / object-store dest-before (this host, after 2026-08-14 slice):
    ...
    Object-store Gate-8 checksum (this host, after 2026-08-14 slice):
      345 passed, 9 skipped in 40.85s (Property 5 + 9 + ADLS/SFTP Gate-8 + Excel phantom).
      ...
      cells via sequential GET. Iceberg `s3://` data files remain
      unmeasured until COUNT uses this Range kernel.
