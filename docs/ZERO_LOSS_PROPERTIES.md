...
10. Lakehouse / object-store dest-before: `destination_row_count` for
    ...
    CSV/TSV RFC 4180 records). GET gzip of CSV/JSON/JSONL/XML streams
    through `GzipFile`; Excel/Avro/Parquet/ORC GET gzip still
    decompresses. JSON-parse
