...
* Inferred deletes on **incremental upsert/CDC** without a tombstone —
  ...
  applies the same kernel when delete parquet is local and `file_path`
  is listed. V3 deletion vectors stay Planned.
