...
70 passed in 5.22s
  ...
  Lakehouse / object-store dest-before (this host, after 2026-08-14 slice):
    ...
    Object-store Gate-8 checksum (this host, after 2026-08-14 slice):
      ...
      `readall()`. Sample/SFTP JSON-`[]` hole remains.
...
* Object-store Gate-8 cell checksum — **PARTIAL**: `checksum_object_store`
  ...
  JSONL does not digest the prefix. Sample / SFTP `_rows_from_object_bytes`
  JSON-`[]` hole remains. Excel/ORC cell walk Planned. Live moto/MinIO
  GET skipped this host.
