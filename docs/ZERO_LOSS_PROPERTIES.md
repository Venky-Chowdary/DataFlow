...
* Iceberg dest-before — **PARTIAL** on filesystem CoW: missing=0, COUNT=2,
  key hits=1, DestBeforeCensus frozen. pyiceberg SqlCatalog live scan
  not run this host (pyiceberg absent). MoR / deletion vectors Planned.
