...
CAPABILITY_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "postgresql": {
        ...
        "cdc_prerequisites": "Enable logical replication and set wal_level=logical; create a publication.",
    ...
    "mysql": {
        ...
        "requires_schema": True,
        "supports_binary": True,
        "cdc_prerequisites": "Enable binlog with ROW format and a server_id.",
    ...
    "sqlserver": {
        ...
        "requires_schema": True,
        "supports_binary": True,
        "cdc_prerequisites": "Enable CDC on the database and source table.",
    ...
    "oracle": {
        ...
        "requires_schema": True,
        "supports_binary": True,
        "cdc_prerequisites": "Enable supplemental logging for GoldenGate/LogMiner CDC.",
    ...
    "snowflake": {
        ...
        "cdc_prerequisites": "Use Snowpipe Streaming or an external stage for CDC; standard tables do not support CDC natively.",
    ...
    "bigquery": {
        ...
        "supports_binary": True,
        "supports_unstructured": True,
        "cdc_prerequisites": "Use BigQuery Storage Write API or scheduled loads. Table CDC is not native.",
    ...
    "mongodb": {
        ...
        "supports_binary": True,
        "supports_unstructured": True,
        "cdc_prerequisites": "Use MongoDB Change Streams with a replica set or sharded cluster.",
        "common_issues": [
    ...
    "kafka": {
        ...
        "supports_binary": True,
        "supports_unstructured": True,
        "cdc_prerequisites": "Use Kafka Connect with Debezium for database CDC. Declare delivery semantics (at-least-once, exactly-once).",
        "common_issues": [
