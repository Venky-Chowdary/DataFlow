...
CAPABILITY_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "postgresql": {
        ...
        "cdc_prerequisites": "Query-based CDC: the source table must have a monotonic cursor column (updated_at/created_at/auto-increment id). Log-based CDC (pgoutput) is not implemented.",
    ...
    "mysql": {
        ...
        "requires_schema": True,
        "supports_binary": True,
        "cdc_prerequisites": "Query-based CDC: the source table must have a monotonic cursor column. Log-based CDC (binlog) is not implemented.",
    ...
    "mongodb": {
        ...
        "supports_binary": True,
        "supports_unstructured": True,
        "cdc_prerequisites": "Query-based CDC: the source collection must have a monotonic cursor field. Change Streams/log-based CDC is not implemented.",
        "common_issues": [
