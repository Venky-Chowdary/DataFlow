...
_FILE_CAPS: dict[str, dict[str, bool]] = {
    ...
    "fixed_width": {"test": True, "read": True, "write": True, "file_source": True, "file_export": True},
...
CATALOG_ID_ALIASES: dict[str, str] = {
    ...
    # OpenShift hosts PostgreSQL (CNPG / Crunchy) — not a dest engine.
