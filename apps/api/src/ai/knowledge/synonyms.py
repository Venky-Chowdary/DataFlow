...
SYNONYM_DICTIONARY: dict[str, list[str]] = {
    ...
    # Financial
    "amount": ["amount", "amt", "value", "sum", "total", "subtotal", "charge", "fee", "balance", "payment", "revenue", "sales", "order_amt", "invoice_amt", "payment_amt", "trans_amt", "txn_amt"],
    "payment_amount": ["payment_amount", "payment_amt", "pay_amt", "paid_amount", "pmt_amount", "pmt_amt"],
    "unit_price": ["unit_price", "unit_prc", "unitprice", "price_per_unit", "sale_price", "list_price", "unit_sale"],
    "unit_cost": ["unit_cost", "unitcost", "cost_per_unit", "unit_cost_price"],
    ...
    "invoice_number": ["invoice_number", "invoice_no", "invoice_num", "inv_number", "inv_no"],
    ...
    "state_code": ["state_code", "state_cd", "province_code", "province_cd", "st_code"],
...
TOKEN_ABBREVIATIONS: dict[str, str] = {
    ...
    "npi": "provider_npi",
    "prc": "unit_price", "price": "unit_price",
    "unit": "unit", "line": "line_amount",
    "net": "net_amount", "gross": "gross_amount",
    "sal": "salary_amount", "salary": "salary_amount",
    "comm": "commission_amount", "commission": "commission_amount",
    "bonus": "bonus_amount",
    "hire": "hire_date", "ship": "ship_date",
    "del": "delivery_date", "delivery": "delivery_date",
    "pay": "payment_amount", "payment": "payment_amount",
    "country": "country_code", "state": "state_code",
    "province": "province_code", "city": "city_name",
    "region": "region_code", "email": "email_address",
