...
def summary(records: list[dict[str, Any]]) -> tuple[int, int, int]:
...
def main() -> int:
    ...
    if args.out:
        ...
        print(f"wrote {args.out}: pass={p} fail={f} skip={s}")
    else:
        print(body)
    return 0
