...
def test_e2e_upload_to_preflight(filename: str) -> None:
    ...
    # schema replacement, control-total and dest-RI gates, each stated on every
    # run (including "nothing to scan") so a ledger SUM / dest RI is never an
    # unasked question.
    assert pf["total_gates"] == 18
